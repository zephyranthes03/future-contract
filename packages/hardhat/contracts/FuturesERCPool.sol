    ...
    ERC20(" DAI LP Token", "writeDAI")
{
    ...
    /*
     * @nonce calls by PutOptions to lock funds
    ...
    /*
     * @nonce Calls by PutOptions to unlock funds
    ...
    /*
     * @nonce Calls by PutOptions to send and lock the premiums
    ...
    /*
     * @nonce Calls by PutOptions to unlock premium after an option expiraton
